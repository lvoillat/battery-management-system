...
MODEL              = BSC
MODULES            = BSC_sf_data.c rtGetInf.c rtGetNaN.c 
MAKEFILE           = BSC.mk
...
MASTER_ANCHOR_DIR  = 
START_DIR          = C:\Sagar\Projects\BMS\P006n\08_Work_in_progress\WP3_2_BMS_Stage_1\BSC\codegen
S_FUNCTIONS        = 
S_FUNCTIONS_LIB    = 
SOLVER             = 
NUMST              = 1
...
MEM_ALLOC          = RT_STATIC
MEXEXT             = mexw64
BUILDARGS          = optimized_floating_point=1 MODELLIB=BSClib.lib RELATIVE_PATH_TO_ANCHOR=.. MODELREF_TARGET_TYPE=NONE ISPROTECTINGMODEL=NOTPROTECTING
CREATEMODEL        = 1
USERMODULES        =  
USEPARAMVALUES     = 0
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\BSC_sfcn_rtw
