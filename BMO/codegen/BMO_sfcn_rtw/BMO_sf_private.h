...
#ifndef RTW_HEADER_BMO_sf_private_h_
#define RTW_HEADER_BMO_sf_private_h_
#include "rtwtypes.h"
 ...
 *
 */
#if !defined(RTW_GENERATED_SFCN_TUNABLE_PRMS_BMO_sf)
#define BMOk_BatteryCurrentThresh(S)   _ssGetSFcnParam(S,0)
#endif                                 /* RTW_GENERATED_SFCN_TUNABLE_PRMS_BMO_sf */
#endif                                 /* RTW_HEADER_BMO_sf_private_h_ */
