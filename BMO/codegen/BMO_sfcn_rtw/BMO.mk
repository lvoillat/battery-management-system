...
MODEL              = BMO
MODULES            = BMO_sf_data.c rtGetInf.c rtGetNaN.c 
MAKEFILE           = BMO.mk
...
MASTER_ANCHOR_DIR  = 
START_DIR          = C:\Sagar\Projects\BMS\P006n\08_Work_in_progress\WP3_2_BMS_Stage_1\BMO\codegen
S_FUNCTIONS        = 
S_FUNCTIONS_LIB    = 
SOLVER             = 
NUMST              = 1
...
MEM_ALLOC          = RT_STATIC
MEXEXT             = mexw64
BUILDARGS          = optimized_floating_point=1 MODELLIB=BMOlib.lib RELATIVE_PATH_TO_ANCHOR=.. MODELREF_TARGET_TYPE=NONE ISPROTECTINGMODEL=NOTPROTECTING
CREATEMODEL        = 1
USERMODULES        =  
USEPARAMVALUES     = 0
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\BMO_sfcn_rtw
