...
#ifndef RTW_HEADER_Cell0_sf_private_h_
#define RTW_HEADER_Cell0_sf_private_h_
#include "rtwtypes.h"
 ...
 *
 */
#if !defined(RTW_GENERATED_SFCN_TUNABLE_PRMS_Cell0_sf)
#define cblc_battChargingMode(S)       _ssGetSFcnParam(S,0)
#define cblc_deltaSocThreshBalance(S)  _ssGetSFcnParam(S,1)
#define cblc_socThreshBalance(S)       _ssGetSFcnParam(S,2)
#endif                                 /* RTW_GENERATED_SFCN_TUNABLE_PRMS_Cell0_sf */
#endif                                 /* RTW_HEADER_Cell0_sf_private_h_ */
